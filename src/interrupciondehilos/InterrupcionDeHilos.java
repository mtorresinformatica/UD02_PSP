/*
 * Programa que lanza dos hilos, ambos pueden ser interrumpidos. Uno porque 
 * realiza una llamada al método sleep() de la clase Thread y gestiona la
 * InterruptedException correspondiente; y el otro porque periódicamente, 
 * comprueba si ha sido interrumpido con el método isInterrupted() de la clase
 * Thread.
 */
